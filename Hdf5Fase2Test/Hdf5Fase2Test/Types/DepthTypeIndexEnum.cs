...
{
    public class DepthTypeIndexEnum : CustomEnumBase
    {
        ...
        public DepthTypeIndexEnum()
        {

        }

        public DepthTypeIndexEnum(byte current)
        {
        ...
        public override void WriteToHdf5(long groupId)
        {
            ...
            try
            {
                ...
                var attr_id = H5A.create(groupId, "depthTypeIndex", enum_id, space_id, acpl, H5P.DEFAULT);
