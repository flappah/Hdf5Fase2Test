...
{
    public class Hdf5GeometryValueInstanceDataSet : Hdf5DataSetBase
    {
        public new List<GeometryValueInstance> Items { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public Hdf5GeometryValueInstanceDataSet()
        {
            Items = new List<GeometryValueInstance>();
        }
        ...
        protected GeometryValueInstance AssignTemplateDataToDataSet(XmlNodeList itemNodes)
        {
            ...
            object datasetInstance = new GeometryValueInstance();
            ...
            return (GeometryValueInstance)datasetInstance;
        }
        ...
        public override void Analyse(XmlNodeList? itemNodes)
        {
            ...
            var geometryValueInstanceDataSet = AssignTemplateDataToDataSet(itemNodes) as GeometryValueInstance?;
            if (geometryValueInstanceDataSet != null)
            {
                Items.Add((GeometryValueInstance)geometryValueInstanceDataSet);
            }
        }
