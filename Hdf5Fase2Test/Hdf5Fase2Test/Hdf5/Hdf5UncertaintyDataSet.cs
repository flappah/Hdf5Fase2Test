...
{
    public class Hdf5UncertaintyDataSet : Hdf5DataSetBase
    {
        public new List<UncertaintyInstance> Items { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public Hdf5UncertaintyDataSet()
        {
            Items = new List<UncertaintyInstance>();
        }
        ...
        protected UncertaintyInstance AssignTemplateDataToDataSet(XmlNodeList itemNodes)
        {
            ...
            object datasetInstance = new UncertaintyInstance();
            ...
            return (UncertaintyInstance)datasetInstance;
        }
        ...
        public override void Analyse(XmlNodeList? itemNodes)
        {
            ...
            var uncertaintyDataset = AssignTemplateDataToDataSet(itemNodes) as UncertaintyInstance?;
            if (uncertaintyDataset != null)
            {
                Items.Add((UncertaintyInstance)uncertaintyDataset);
            }
        }
