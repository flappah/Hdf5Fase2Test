...
{
    public class DataCodingFormatEnum : CustomEnumBase
    {
        ...
        public DataCodingFormatEnum()
        {

        }

        public DataCodingFormatEnum(byte current)
        {
        ...
        public override void WriteToHdf5(long groupId)
        {
            ...
            try
            {
                ...
                var attr_id = H5A.create(groupId, "dataCodingFormat", enum_id, space_id, acpl, H5P.DEFAULT);
